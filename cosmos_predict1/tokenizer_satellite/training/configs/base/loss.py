...
from cosmos_predict1.tokenizer_satellite.training.losses.continuous import (
    ColorLoss,
    FlowLoss,
    KLLoss,
    PerceptualLoss,
...
class PerceptualConfig:
    ...
    # Path to VGG16 weights file. If specified, will load directly from this path
    # instead of downloading from torchvision. This avoids network conflicts in distributed training.
