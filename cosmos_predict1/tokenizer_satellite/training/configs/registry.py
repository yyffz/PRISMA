...
from cosmos_predict1.tokenizer_satellite.training.configs.base.callback import BASIC_CALLBACKS
from cosmos_predict1.tokenizer_satellite.training.configs.base.checkpoint import CHECKPOINT_LOCAL
from cosmos_predict1.tokenizer_satellite.training.configs.base.data import DATALOADER_OPTIONS
from cosmos_predict1.tokenizer_satellite.training.configs.base.loss import VideoLossConfig
from cosmos_predict1.tokenizer_satellite.training.configs.base.metric import DiscreteTokenizerMetricConfig, MetricConfig
from cosmos_predict1.tokenizer_satellite.training.configs.base.net import (
...
from cosmos_predict1.tokenizer_satellite.training.configs.base.optim import (
    AdamWConfig,
    FusedAdamConfig,
...
def register_training_data(cs):
    ...
    cs.store(
        group="data_train",
        package="dataloader_train",
        name="gmi_loader_basic",
        node=DATALOADER_OPTIONS["gmi_loader_basic"](
