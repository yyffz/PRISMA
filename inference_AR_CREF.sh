...
#     --data_dir /public/share/users/sunhaofei/Radar_Data/202508/ \
#     --save_dir ./ \
#     --start_str 20250825000000 \
#     --end_str 20250826000000 \
#     --start_lon 114 \
#     --start_lat 28 
...
# python workspace/Step4_SelectCase.py  \
#     --input_dir ./case_0825/ \
#     --output_dir ./case_0825_AR \




CUDA_HOME=$CONDA_PREFIX PYTHONPATH=$(pwd) python cosmos_predict1/autoregressive/inference/CREF_base.py \
    ...
    --offload_tokenizer \
    --video_save_name AR_pred_08250600 
